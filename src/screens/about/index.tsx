...
export default function About() {
  return (
    <Container>
      ...
      <Text>
        A Festa do Milho UNIFASIPE chega na sua 15º edição, sendo considerada o
      ...
      >
        <ButtonText>DÊ SUA OPINIÃO SOBRE A FESTA DO MILHO</ButtonText>
      </Button>
      ...
      <TextCenter style={{ marginBottom: 15 }}>
        você será redirecionado para web ao clicar nos botões acima
      </TextCenter>
